 ...
 *
 * Usage from the app:
 *   import { seedChallengeLibrary } from '../utils/seedChallengeLibrary';
 *   await seedChallengeLibrary();
 */
...
const CHALLENGE_LIBRARY_SEED_DATA: SeedChallenge[] = [
  {
...
/**
 * Seed the challenge library with all challenges from the draft
...
export async function seedChallengeLibrary(): Promise<number> {
  ...
  console.log(`Seeding complete! Added ${addedCount} challenges.`);
  return addedCount;
}
